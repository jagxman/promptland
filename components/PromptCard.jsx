  ...
  return (
    <div className="prompt_card">
      <div className="flex justify-between items-start gap-5">
        <div className="flex-1 flex justify-start items-center gap-4 cursor-pointer" onClick={handleProfile}>
          <Image
          ...
          <div className="flex flex-col">
            <h3 className="font-satoshi font-semibold dark:text-white">
              {post.creator?.username}
            </h3>
            <p className="font-inter text-sm dark:text-gray">
              {post.creator?.email}
            </p>
          </div>
        </div>
        ...
        <div className="copy_btn" onClick={handleCopy}>
          <Image  alt="user_copy" src={copied === post.prompt ? '/assets/icons/tick.svg' : '/assets/icons/copy.svg'} width={12} height={12}/>
        </div>
      </div>
